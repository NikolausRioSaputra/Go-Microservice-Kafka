...
func main() {
	...
	reader := repository.NewKafkaReaderRepository([]string{"localhost:29092"}, "topic_validate_item", "my-consumer-group") // -> membaca dari topic melalui broker di localhost, membaca topic topic_activatepackage
